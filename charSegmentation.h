...
void cutChar(unsigned int pos1, unsigned int pos2, unsigned int matrix[], 
    unsigned int width, unsigned int heigth, unsigned int numberOfLine, 
...
unsigned int charSave(unsigned int list[], unsigned int matrix[], 
    unsigned int width, unsigned int heigth, unsigned int numberOfLine, 
        unsigned int numberOfWord, unsigned int newWidth, unsigned int Height);
...
unsigned int * cutLineChar(unsigned int pos1, unsigned int pos2, 
                unsigned int matrix[], unsigned int width, unsigned int height);
#endif
